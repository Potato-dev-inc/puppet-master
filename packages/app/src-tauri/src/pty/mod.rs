...
pub use registry::{
    ...
    resize as registry_resize,
    set_project_path as registry_set_project_path, spawn_pane as registry_spawn_pane,
    write_input as registry_write_input, PaneInfo, PaneRegistry, SpawnPaneArgs,
};
